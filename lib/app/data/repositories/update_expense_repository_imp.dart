import 'package:my_expenses/app/data/data_sources/local/update_expense_local_data_source.dart';
import 'package:my_expenses/app/domain/entities/expense_entity.dart';
import 'package:my_expenses/app/domain/repositories/update_expense_repository.dart';

class UpdateExpenseRepositoryImp extends UpdateExpenseRepository {
  final UpdateExpenseLocalDataSource _updateExpenseLocalDataSource;
